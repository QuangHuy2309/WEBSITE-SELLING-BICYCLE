...
<div class="bikes">
	<div class="road-sec">
		<h2>ORDERS</h2>
		<br>
		<a href="changetoproduct.htm" class="btn btn-info" role="button">Products</a>
		<br>
		<br>
		<span>${message}</span>
		...
		<c:forEach var="u" items="${orders}">
			<tr>
				...
				<td>		
					<c:choose>
			    	<c:when test="${u.getStatus() == '0'}">
			    		<a href="editstatus.htm?id=${u.id}" class="btn btn-warning" role="button">DELIVERED</a>	
			    		<button type="button" class="btn btn-dark">Delete</button>
			    	</c:when>    
			    	<c:otherwise>
			    		<button type="button" class="btn btn-success">DELIVERED</button>
			    		<a href="deleteorder.htm?id=${u.id}" class="btn btn-danger" role="button">Delete</a>			
			    	</c:otherwise>		
			    	</c:choose>
